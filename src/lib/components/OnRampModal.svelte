...
<div class="fixed inset-0 z-50 flex items-center justify-center bg-opacity-50">
	<div class="relative flex h-[90vh] w-[90vw] flex-col rounded-lg bg-[#1d1f25] md:flex-row">
		<button class="absolute right-2 top-2 rounded-full bg-gray-200 p-2" on:click={onClose}>
		...
		>
			<div class="mb-4 text-xl font-medium">Instructions</div>
			...
			<div class="flex flex-col gap-2">
				...
				<div class="flex flex-col gap-2">
					<div>
						3. Things will look like the image below. Click <span class="font-semibold"
							>Buy Now</span
				...
				<div class="flex flex-wrap items-center gap-2">
					...
					<div class="flex items-center gap-2">
						<span class="rounded-md bg-neutral-800 px-1 py-0.5 font-mono text-gray-100"
							>{walletAddress}</span
						>
						<button
		...
		<iframe src="https://global.transak.com/" title="Deposit" class="h-full w-1/2 rounded-r-lg"
		></iframe>
	</div>
</div>
